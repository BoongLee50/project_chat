...
**⚠️ 기획서 안에서 어긋나는 것 10가지**를 찾아 [12 §6](12-plan3-diff.md)에 정리했다.
특히 **[보낸 신청] 탭의 존재**(본문엔 있고 화면엔 없다), **대화 신청 10회 무료의 기준**(하루인지 계정 누적인지),
**하루 한 마디의 행방**(어디에도 없다) 셋은 **스키마가 갈리므로 착수 전에 반드시 확인**해야 한다.
